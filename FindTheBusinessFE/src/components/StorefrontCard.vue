    ...
    <vk-card padding="small" class="uk-card-hover uk-flex"> 
      <div class="uk-flex uk-flex-stretch uk-flex-column" style="width: 100%">
        <div>
          ...
          <img loading="lazy" :style="(hasImageLoaded == false) ? 'visibility: hidden' : 'visibility: visible'" v-if="cannotFindImage == false && image != null" :src="image" :alt="title" class="card-image"  @error="cannotFindImage = true" @load="onImgLoad">
