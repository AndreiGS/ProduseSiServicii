...
public class EmailUtil {
    ...
    public void sendConfirmationForRegistrationEmail(String email, String url, String action) throws AddressException, MessagingException, IOException, NoSuchAlgorithmException {
        ...
        Session session = Session.getInstance(props, new javax.mail.Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("produsesiservicii.ro@gmail.com", System.getenv("EMAIL_APP_PASS"));
            }
        });
    ...
    public void sendEmail(String email, String content) throws AddressException, MessagingException, IOException, NoSuchAlgorithmException {
        Properties props = new Properties();
        props.put("mail.smtp.auth", "true");
        props.put("mail.smtp.starttls.enable", "true");
        props.put("mail.smtp.host", "smtp.gmail.com");
